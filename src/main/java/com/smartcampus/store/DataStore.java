...
public class DataStore {
    ...
    private DataStore() {
        ...
        Sensor s2 = new Sensor("HUM-001",  "Humidity",    "ACTIVE", 55.0, "LIB-301");
        Sensor s3 = new Sensor("TEMP-002", "Temperature", "ACTIVE", 21.0, "LAB-101");
        ...
        r1Readings.add(new SensorReading(
                UUID.randomUUID().toString(),
                System.currentTimeMillis() - 60000, 21.5));
        r1Readings.add(new SensorReading(
                UUID.randomUUID().toString(),
